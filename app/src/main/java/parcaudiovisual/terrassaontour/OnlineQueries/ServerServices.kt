package parcaudiovisual.terrassaontour.OnlineQueries

import android.util.Log
import org.json.JSONObject
import parcaudiovisual.terrassaontour.database.Audiovisual
import parcaudiovisual.terrassaontour.database.POI
import parcaudiovisual.terrassaontour.database.Route
import parcaudiovisual.terrassaontour.database.Statics
import java.io.*
...
class ServerServices {
    ...
    companion object {
        ...
        @Synchronized
        fun getInstance(): ServerServices {
            if (instance == null) {
