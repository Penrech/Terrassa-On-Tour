...
class InfoElementsNoLinkRecyclerAdapter(private val context: Context, private var list: List<String>) : androidx.recyclerview.widget.RecyclerView.Adapter<InfoElementsNoLinkRecyclerAdapter.ViewHolder>() {
